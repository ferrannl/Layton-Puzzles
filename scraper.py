...
# The precise verified URL blueprints across all 6 mainline games
GAMES_CONFIG = {
    "curious-village": {
...
def scrape_puzzle(base_url, pid):
    ...
    # Extract all images from the core post frame
    ...
    # Asset sorting blueprint to distribute content among layout slots safely
    ...
    # Parse alternative answer string markers
    solution_text = ""
    if post_body:

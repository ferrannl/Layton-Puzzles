...
function installMorePuzzlesModal(triggerBtn){
  ...
  // Updated link descriptions to mark "Diabolical Box" as current
  const links = [
    { name: "Curious Village", url: "https://ferrannl.github.io/Layton-Puzzles/" },
    { name: "Diabolical Box (the one you're on)", url: "https://ferrannl.github.io/Layton-Puzzles/diabolical-box.html" },
